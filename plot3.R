...
# Makes the third plot of the course project in week 1
# Sub metering for all three submeters as a function of time
...
# Add the two other plots
lines(tab$Sub_metering_2, col = "red")
lines(tab$Sub_metering_3, col = "blue")

# Add the legend
legend("topright", legend = names(tab)[7:9], lty = 1, col = c("black", "red", "blue"))
